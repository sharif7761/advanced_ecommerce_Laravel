                                ...
                                <div class="row mg-b-25">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="post_title_en" placeholder="Post Title (English)" value="{{ $post->post_title_en }}" required>
                                        </div>
                                    </div><!-- col-6 -->
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label">Post Title (Bengali): <span class="tx-danger">*</span></label>
                                            <input class="form-control" type="text" name="post_title_bn" placeholder="Post Title (Bengali)" value="{{ $post->post_title_bn }}" required>
                                        </div>
                                    </div><!-- col-6 -->
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="summernote2" name="details_bn">{!! $post->details_bn !!}</textarea>
                                        </div>
                                    </div><!-- col-12 -->
                                    <div class="col-lg-4">
                                        <div class="form-group">
