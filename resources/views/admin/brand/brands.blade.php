    ...
    <div class="sl-mainpanel">
        <div class="sl-pagebody">
            <div class="sl-page-title">
                <label>Brand Table</label>
                <a href="" class="btn btn-sm btn-warning float-right" data-toggle="modal" data-target="#modaldemo3">Add Brand</a>
            </div><!-- sl-page-title -->
                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ url('delete/category/'.$brand->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
                    ...
                    <div class="modal-content tx-size-sm">
                        ...
                        <form method="post" action="{{ route('store.brand') }}" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-info pd-x-20">Save Brand</button>
